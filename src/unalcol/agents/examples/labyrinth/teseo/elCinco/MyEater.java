 ...
 * @author Jose
 */
public class MyEater extends EaterAgent{
    ...
    @Override
    public int accion(boolean PF, boolean PD, boolean PA, boolean PI, boolean MT, boolean RE, Boolean RE_C, Boolean RE_SH, Boolean RE_SI, Boolean RE_W, int EN) {
